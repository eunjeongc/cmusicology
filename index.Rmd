...
What accounts for the prevalent use of seventh chords in K-pop songs? {.storyboard}

==========================================================================

### Chordogram of 'Standing Next to You (2023)' by Jung Kook
...
------------------------------------------------------------------------
Comparison between the two different tracks can be found in the next tab.

### Chordogram of 'Tell Me (2007)' by Wonder Girls
...
### Chordogram of 'Easy (2024)' by LE SSERAFIM
...
**Couldn't get to put the cepstrograms one below another, so the 'Tell Me (2007)' cepstrogram is in another tab for now.

### Tell Me (2007) Cepstrogram
```{r}
wgirls_timbre <-
